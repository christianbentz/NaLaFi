...
## Description
This file contains the code for estimating the feature values (TTR, unigram entropy, entropy rate, repetition rate) per character chunk (one per line) for each file in the NaLaFi/samples folder. The estimations are saved one per line in a csv file in NaLaFi/results. 
