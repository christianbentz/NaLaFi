...
for (file in file.list) 
{
  ...
  textfile <- scan(file, what = "char", quote = "", 
                   comment.char = "", encoding = "UTF-8", sep = "\n" , skip = 16, nmax = 20) # skip 7 for stringbase
...
ggsave("Figures/stabilization_huni_chars.pdf", huni.chars.plot, dpi = 300, 
...
## Safe figure to file
```{r, fig.width = 20, fig.height = 20}
ggsave("Figures/stabilization_hrate_chars.pdf", hrate.chars.plot, dpi = 300, 
       scale = 1, device = cairo_pdf)
```
...
## Safe figure to file
```{r, fig.width = 20, fig.height = 20}
ggsave("Figures/stabilization_ttr_chars.pdf", ttr.chars.plot, dpi = 300, 
       scale = 1, device = cairo_pdf)
```