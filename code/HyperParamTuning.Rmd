...
mlp.10chars.results <- read.csv("~/Github/NaLaFi/results/MLP/results_MLP_10chars_logistic_ce_rprop+.csv")
mlp.100chars.results <- read.csv("~/Github/NaLaFi/results/MLP/results_MLP_100chars_logistic_ce_rprop+.csv")
mlp.1000chars.results <- read.csv("~/Github/NaLaFi/results/MLP/results_MLP_1000chars_logistic_ce_rprop+.csv")
