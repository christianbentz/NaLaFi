...
estimations100.df <- estimations100.df[!(estimations100.df$subcorpus %in% selected), ]
...
huni.hrate.10chars.plot <- ggMarginal(huni.hrate.10chars.plot, groupFill = T, 
                                    type = "histogram", colour = "white")
...
ttr.rm.10chars.plot <- ggMarginal(ttr.rm.10chars.plot, groupFill = T, 
                                type = "histogram", colour = "white")
#ttr.rm.10chars.plot
```
...
huni.hrate.100chars.plot <- ggplot(estimations100.df, 
  ...
  theme(legend.position = "none")
huni.hrate.100chars.plot <- ggMarginal(huni.hrate.100chars.plot, groupFill = T, 
                                    type = "histogram", colour = "white")
...
ttr.rm.100chars.plot <- ggMarginal(ttr.rm.100chars.plot, groupFill = T, 
                                type = "histogram", colour = "white")
...
huni.hrate.1000chars.plot <- ggplot(estimations1000.df, 
  ...
  theme(legend.position = "none")
huni.hrate.1000chars.plot <- ggMarginal(huni.hrate.1000chars.plot, groupFill = T, 
                                    type = "histogram", colour = "white")
...
ttr.rm.1000chars.plot <- ggMarginal(ttr.rm.1000chars.plot, groupFill = T, 
                                type = "histogram", colour = "white")
