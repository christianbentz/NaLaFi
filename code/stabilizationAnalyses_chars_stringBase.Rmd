---
title: 'Stabilization Analyses for Characters: StringBase'
author: "Chris Bentz"
date: "25/02/2021"
output:
  html_document:
...
ggsave("Figures/stabilization_huni_chars_stringBase.pdf", huni.chars.plot, dpi = 300, 
...
## Safe figure to file
```{r, fig.width = 20, fig.height = 20}
ggsave("Figures/stabilization_hrate_chars_stringBase.pdf", hrate.chars.plot, dpi = 300,
       scale = 1, device = cairo_pdf)
```
...
## Safe figure to file
```{r, fig.width = 20, fig.height = 20}
ggsave("Figures/stabilization_ttr_chars_stringBase.pdf", ttr.chars.plot, dpi = 300, 
       scale = 1, device = cairo_pdf)
```